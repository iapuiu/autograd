...
SparseArrayBox.register(sp.dia.dia_matrix)
SparseArrayBox.register(sp.csr.csr_matrix)
SparseArrayBox.register(sp.coo.coo_matrix)
SparseArrayBox.register(sp.csc.csc_matrix)
